...
def test_bibliography_deduplication():
    bib = Bibliography()
    cit1 = Citation(bibtex_key="a1", title="Paper A", authors=["Author"], year=2020, doi="10.1/123")
    cit2 = Citation(bibtex_key="a2", title="Paper A", authors=["Author"], year=2020, doi="10.1/123")
